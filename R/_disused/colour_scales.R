...
# Text
legend_names <- c(
  "htn140" = "Hypertension", "diag140" = "Diagnosis", "treat140" = "Treatment", "ctrl140" = "Control",
...
get_fill_scale <- function(var, minqt, maxqt, type) {
  if (type == "levels") {
    return(get_fill_scale_level(var, minqt, maxqt))
  }
  if (type == "changes") {
    return(get_fill_scale_change(var, minqt, maxqt))
  }
  return(NA)
}
